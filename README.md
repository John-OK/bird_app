...
![HelloBirdie Banner](https://github.com/John-OK/bird_app/blob/main/github_assets/Eurasian_Sparrowhawk.jpg)
...
[See demonstrations of three use cases of HelloBirdie](https://github.com/John-OK/bird_app/blob/main/DEMO.md)
...
NOTE: If this command throws an error, follow the instructions provided in the error to install 'venv' (but prepend the line with 'sudo')<br><br> 4. Source the virtual environment
